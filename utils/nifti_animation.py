...
def run_main(input_nifti, write_directory, color_map, color_max, xyz_coords, figure_dimensions):
    ...
    write_animation_ffmpeg(input_nifti_base, write_directory, i)

def write_animation_ffmpeg(file_base, write_directory, img_n, frame_rate=10):
    # Write file
    cmd = """
